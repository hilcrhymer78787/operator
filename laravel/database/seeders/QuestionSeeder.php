...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('questions')->insert([
            ...
            ['question_content' => '出勤したら必ずプレート＆ダンサーの時間を確認し、被らないように気をつけている'],
            ...
            ['question_content' => 'プレート、ダンスショー5分前にはそのフロアでのパフォーマンスを中断している'],
            ['question_content' => 'パフォーマンス前、最中にグラス等の安全確認ができている'],
            ['question_content' => 'テーブル時間5分を守れている'],
            ...
            ['question_content' => '混雑時アンコールの時は「特別に次が最後です」と念を押した上で2分以内１演目で納めている'],
            ['question_content' => 'シフト交代をする時は必ず交代理由を添えている'],
            ['question_content' => 'シフト交代をしてもらったら前日にリマインドが来るように「イベント」で設定をしている'],
            ...
            ['question_content' => '23:00以降にパフォーマンスをしてい'],
            ['question_content' => 'アンケートに記入を促す行為をしない'],
            ['question_content' => 'グループLINEで代演を探してる人がいて自分は出れない時は翌日23:59までに必ず「出れない」と返事をして'],
            ['question_content' => 'TOPの許可なしにステージマジックを行なっていない'],
            ['question_content' => 'お店に対し意見反論がある場合は直接議論せず、必ずTOPに相談する'],
            ['question_content' => 'スタッフに「あのテーブル入って」と依頼されたら速やかに入っている'],
            ['question_content' => '料理の上でパフォーマンスをしていない'],
            ...
            ['question_content' => 'テーブルに入っていない時間は短いか'],
